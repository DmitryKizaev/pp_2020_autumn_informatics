...
#include <iostream>
#include <utility>
#include "../../../modules/task_2/kizaev_d_ribbon_scheme/ribbon_scheme.h"
...
std::vector<double> sequentialMatrixMult(std::vector<double> A, std::vector<double> B, int size) {  // B transposed!
...
std::vector<double> parallelMatrixMult(const std::vector<double> &A, const std::vector<double> &B, int size) {
    ...
    for (int i = 0; i < procpart; i++) {  // localB transposed!
